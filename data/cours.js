(function () {
  ...
  P("chrono-usage", {
    sections: [
      ...
      { type: "connaitre", title: "À connaître parfaitement", ul: ["Carte conducteur = personnelle, jamais celle d'un autre", "Contrôle : journée en cours + 56 jours", "Téléchargement carte par l'entreprise : 28 jours", "Boîtier véhicule (VU) : 90 jours", "4 modes : conduite, autre travail, dispo, repos", "Saisie manuelle si un temps a été oublié"] },
